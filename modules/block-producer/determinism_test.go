...
func TestSortedMapKeys(t *testing.T) {
	// Simulate the maps used in MakeOutputs
	...
	// Run 100 times — Go randomizes map iteration order per-run
...
func TestSortedDeletionsAndCache(t *testing.T) {
	...
	// Simulate sorted cache application (skipping deleted keys)
...
func TestSortedLogIds(t *testing.T) {
	// Simulate PopLogs output from a cross-contract call
	// e.g. mapping contract calls router, router calls pool
